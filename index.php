    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-black mb-5">
        ...
        <div class="navbar-collapse collapse justify-content-between" id="mainnavbar">
            <div class="navbar-nav gap-2">
                ...
                <a class="btn btn-warning" href="dolar.php"><i class="fa-solid fa-dollar-sign"></i> USD</a>
            </div>
    ...
    <div class="container">
        <div class="card-group">
            ...
            <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                    <p>Compra de R$ 500 em Bitcoin em 10/06/2023</p>
                    <p>Venda de R$ 80 em Bitcoin em 22/10/2023</p>
                    <p>Compra de R$ 150 em Bitcoin em 15/02/2024</p>
